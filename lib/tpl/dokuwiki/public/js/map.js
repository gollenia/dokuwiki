...
/* harmony import */ var jsvectormap__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! jsvectormap */ "./node_modules/jsvectormap/dist/js/jsvectormap.min.js");
/* harmony import */ var jsvectormap__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(jsvectormap__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var jsvectormap_dist_maps_world_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! jsvectormap/dist/maps/world.js */ "./node_modules/jsvectormap/dist/maps/world.js");
/* harmony import */ var jsvectormap_dist_maps_world_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(jsvectormap_dist_maps_world_js__WEBPACK_IMPORTED_MODULE_2__);
...
var map = new (jsvectormap__WEBPACK_IMPORTED_MODULE_1___default())({
  selector: '#map',
  map: 'world',
  visualizeData: {
    scale: ['#c9dfff', '#0d6efd'],
  ...
  onRegionTooltipShow: function onRegionTooltipShow(event, tooltip, code) {
    console.log(tooltip.text()); // When hovering over Canada region the tooltip will change.

    if (code in DOKU_STATS.country) {
      tooltip.text("\n        ".concat(tooltip.text(), ": ").concat(DOKU_STATS.country[code], "\n      "), true);
    }
  }
});
...
chart_js__WEBPACK_IMPORTED_MODULE_0__.Chart.defaults.font.family = "'Exo 2', 'Helvetica Neue', 'Helvetica', 'Arial'";
var element = document.getElementById('platform');
var myChart = new chart_js__WEBPACK_IMPORTED_MODULE_0__.Chart(element, {
  type: 'pie',
  data: {
...
var labels = DOKU_STATS.year.months.map(function (month) {
  return months[month - 1];
});
var ycelement = document.getElementById('year');
...
var yearChart = new chart_js__WEBPACK_IMPORTED_MODULE_0__.Chart(ycelement, {
  type: 'line',
  data: {
    labels: labels,
    datasets: [{
