...
const MediaManager = (props: Props) => {
    ...
    const {
        state: { mediamanager, files, article },
        dispatch,
    } = globalState;
    ...
    return (
        <div>
            <div
                className={'modal modal-xl fade ' + (mediamanager ? 'show' : '')}
                            ...
                            <div className="modal-body mediamanager">
                                <div className="container">
                                    <div className="p-4 d-flex gap-2 align-items-center filter">
                                        ...
                                        <button
                                            className={
                                                'btn ' + (sort == 'date' ? 'btn-secondary' : 'btn-outline-secondary')
                                            }
                                            onClick={() => resort('date')}
                                        >
                                            Datum
                                        ...
                                        <button
                                            className={
                                                'btn ' + (sort == 'normal' ? 'btn-secondary' : 'btn-outline-secondary')
                                            }
                                            onClick={() => resort('normal')}
                                        >
                                            Name
                                        </button>
                                    </div>
